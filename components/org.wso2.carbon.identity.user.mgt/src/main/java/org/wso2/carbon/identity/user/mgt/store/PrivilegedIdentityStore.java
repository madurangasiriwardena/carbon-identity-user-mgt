...
public interface PrivilegedIdentityStore extends IdentityStore {
    ...
    void updateUserClaims(String userId, List<Claim> userClaimsToUpdate, List<Claim> userClaimsToRemove) throws IdentityStoreException;
    void updateUserClaims(String userId, List<Claim> userClaimsToUpdate, List<Claim> userClaimsToRemove, String domain) throws IdentityStoreException;
    ...
    void updateGroupsOfUser(String userId, List<GroupModel> groupsToUpdate, List<GroupModel> groupsToRemove) throws IdentityStoreException;
    void updateGroupsOfUser(String userId, List<GroupModel> groupsToUpdate, List<GroupModel> groupsToRemove, String domain) throws IdentityStoreException;
    ...
    Group updateGroupClaims(String groupId, List<Claim> groupClaimsToUpdate, List<Claim> groupClaimsToRemove) throws IdentityStoreException;
    Group updateGroupClaims(String groupId, List<Claim> groupClaimsToUpdate, List<Claim> groupClaimsToRemove, String domain) throws IdentityStoreException;
    ...
    void updateUsersOfGroup(String groupId, List<UserModel> usersToUpdate, List<UserModel> usersToRemove) throws IdentityStoreException;
    void updateUsersOfGroup(String groupId, List<UserModel> usersToUpdate, List<UserModel> usersToRemove, String domain) throws IdentityStoreException;
